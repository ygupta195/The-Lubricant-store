...
<body>
    ...
    <p id="message">Your order has been placed</p>
    <p id="message">Thank you for shopping with us!</p>
    <a href="2-product.php">
        <button id="ck1">Continue Shopping</button>
    </a>
    <a href="login.php">
        <button id="ck2">LogOut</button>
    </a>
</body>
<footer>
    <div id="info">
